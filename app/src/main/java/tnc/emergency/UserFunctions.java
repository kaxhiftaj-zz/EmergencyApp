...
public class UserFunctions {
    ...
    private static String NumberURL = "http://staging.techeasesol.com/daniyal/APIs/api.return_location_on_lat_long.php";
    private static String DataURL = "http://staging.techeasesol.com/daniyal/APIs/api.backup_data_to_phone.php";
